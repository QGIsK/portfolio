<template>
  <div style="z-index: 10">
    <v-toolbar flat style="cursor: pointer; background: transparent; z-index: 10">
      ...
      <v-toolbar-title @click="redirect('/')" style="margin-left: 7.5vh" class="headline"
...
<script>
import { VToolbar, VToolbarTitle, VSpacer, VToolbarItems, VBtn } from 'vuetify/lib'

export default {
  name: 'Navbar',
  components: { VToolbar, VToolbarTitle, VSpacer, VToolbarItems, VBtn },
  methods: {
    redirect(path) {
